...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 10, 2023 at 04:44 PM
...
INSERT INTO `customers` (`id`, `username`, `password`, `role`, `status`, `created_at`, `provider`) VALUES
(7, '1', '$2y$10$lgLUo6hz8BH2LWGeNgBjf.GvUSYpzdShXrGqbOcWPWCpPJOVVtzWS', 'admin', 'yes', '2023-03-14', 'email'),
(8, '2', '$2y$10$dBGpq0GdCbTEMsnSDKf9uOA8rv0Kzw9dTuq19ji/deBsHoBmK3BIq', 'member', 'no', '2023-03-15', 'email'),
(9, '9372642011', '$2y$10$NWurzi0zsuwdQ634ubdeUe3w/ibjIPeWugt/3BRfdY8oo8pTHqknm', 'member', 'yes', '2023-03-20', 'email'),
(10, '9167770980', '$2y$10$6MrI3TGgue8z/nw8x5Pa.O2Mj2E7IRX8ybjn..t2XfSO4SRcQijFi', 'member', 'no', '2023-03-20', 'email');
...
--
-- Constraints for table `clicked`
--
ALTER TABLE `clicked`
  ADD CONSTRAINT `post_id` FOREIGN KEY (`post_id`) REFERENCES `post` (`post_id`) ON DELETE NO ACTION;

--
-- Constraints for table `contact_us`
--
ALTER TABLE `contact_us`
  ADD CONSTRAINT `cust_id_fk` FOREIGN KEY (`cust_id`) REFERENCES `customers` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `cust_info`
--
ALTER TABLE `cust_info`
  ADD CONSTRAINT `username` FOREIGN KEY (`username`) REFERENCES `customers` (`username`) ON DELETE CASCADE ON UPDATE NO ACTION;
COMMIT;
