...
$select_prefill_query="select * from post where post_id=$post_id";
$select_prefill_query_result=mysqli_query($conn,$select_prefill_query)->fetch_assoc();

$usercheck="select username from post where post_id=$post_id";
$usercheck_res=mysqli_query($conn,$usercheck)->fetch_assoc();
if ($usercheck_res["username"]!=$username and $_SESSION["role"]!="admin"){
...
if (isset($_POST['submit'])) {
  ...
  $update_post = "update post set title='$title', description='$description', location='$location', price=$price, area='$area', bhk=$bhk, floor=$floor, furnished='$furnished', possesion='$possesion' ,district='$district' ,pincode=$pincode where post_id=$post_id";
  $res_insert_post = mysqli_query($conn, $update_post);
  // echo (var_dump($res_insert_post));
  // exit();
  if ($res_insert_post) {
    if ($_FILES['images']['name'][0]!=""){
      $select_img_query=mysqli_query($conn, "SELECT * from images WHERE post_id=$post_id");
      while($sel_img=$select_img_query->fetch_assoc()){
          unlink($sel_img["path"]);
          
      }
      $delete_img_query="DELETE FROM images WHERE post_id = $post_id";
      $delete_img_query_res=mysqli_query($conn,$delete_img_query);
      // $default_img_path='./images/default.jpg';
      // $insert_img_default = "insert into images (path,post_id) values('$default_img_path',$post_id)";
...
<head>
  <meta charset="utf-8" />
    ...
    <meta name="title" content="Edit your property | HousingAdda" />
  ...
  <title>
    Edit your property | HousingAdda
  </title>
        ...
        <div class="row">
          ...
          <span class="d-block d-flex align-items-center justify-content-center">
            <div action="" class="home__search " style="width:60%">
              ...
              <input type="search" name="title" value="<?php echo $select_prefill_query_result['title']?>" class="home__search-input " style="width:80%" required>
          ...
          <span class="d-block d-flex align-items-center justify-content-center">
            <div action="" class="home__search " style="width:60%">
              ...
              <input type="search"  name="location" value="<?php echo $select_prefill_query_result['location']?>" class="home__search-input " style="width:90%"  required>
              <!-- <button class="searchbutton" type="submit">Search</button> -->
          ...
          <span class="d-block d-flex align-items-center justify-content-center">
            <div action="" class="home__search " style="width:60%">
              ...
              <input type="search" id="pincode" maxLength="6" value="<?php echo $select_prefill_query_result['pincode']?>" name="pincode" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="home__search-input " style="width:90%" required>
              <!-- <button class="searchbutton" type="submit">Search</button> -->
          ...
          <span class="d-block d-flex align-items-center justify-content-center">
            <div action="" class="home__search " style="width:60%">
              ...
              <input type="text" value="<?php echo $select_prefill_query_result['district']?>" placeholder="<?php echo $select_prefill_query_result['district']?>" id="district" name="district" class="home__search-input " style="width:90%;color:hsl(228,12%,75%);" readonly>
              <!-- <button class="searchbutton" type="submit">Search</button> -->
            </div>
          </span>
          ...
          <span class="d-block d-flex align-items-center justify-content-center">
            <div action="" class="home__search " style="width:60%">
              ...
              <input type="number" value="<?php echo $select_prefill_query_result['price']?>" name="price" class="home__search-input " required>
              <!-- <button class="searchbutton" type="submit">Search</button> -->
          ...
          <span class="d-block d-flex align-items-center justify-content-center">
            <div action="" class="home__search " style="width:60%">
              ...
              <textarea type="text" rows="4" cols="50" name="description" required class="home__search-input " style="width:90%;"><?php echo $select_prefill_query_result['description']?></textarea>
              <!-- <button class="searchbutton" type="submit">Search</button> -->
          ...
          <span class="d-block d-flex align-items-center justify-content-center">
            <div action="" class="home__search " style="width:60%">
              ...
              <input type="search" value="<?php echo $select_prefill_query_result['area']?>" name="area" required class="home__search-input ">
              <!-- <button class="searchbutton" type="submit">Search</button> -->
          ...
          <span class="d-block d-flex align-items-center justify-content-center">
            <div action="" class="home__search " style="width:60%">
              ...
              <input type="number" step="0.01" value="<?php echo $select_prefill_query_result['bhk']?>" name="bhk" required class="home__search-input ">
              <!-- <button class="searchbutton" type="submit">Search</button> -->
          ...
          <span class="d-block d-flex align-items-center justify-content-center">
            <div action="" class="home__search " style="width:60%">
              ...
              <input type="number" name="floor" value="<?php echo $select_prefill_query_result['floor']?>" required class="home__search-input ">
              <!-- <button class="searchbutton" type="submit">Search</button> -->
          ...
          <span class="d-block d-flex align-items-center justify-content-center">
            <div action="" class="home__search " style="width:60%">
              ...
              <input type="month" name="possesion" value="<?php echo $select_prefill_query_result['possesion']?>" required value="2023-03" class="home__search-input " style="width:90%;color:var(--text-color-light);">
              <!-- <button class="searchbutton" type="submit">Search</button> -->
          ...
          <span class="d-block d-flex align-items-center justify-content-center">
            <div action="" class="home__search " style="width:60%">
              ...
              <select name="furnished" id="furnished" name="furnished" required class="home__search-input" style="width:90%;color:var(--text-color-light);">
                <option value="yes" <?php echo ($select_prefill_query_result['furnished']=='Yes'? 'selected':'')?>>Yes</option>
                <option value="no" <?php echo ($select_prefill_query_result['furnished']=='No'? 'selected':'')?>>No</option>
              </select>
            </div>
          </span>
          ...
          <div class="text-center mt-3">
            <button type="submit" class="searchbutton" name="submit" style="width:60%; border-radius: .75rem;">Confirm Edits</button>
          </div>
          <!--Script-->
