...
$email= $_SESSION["mail"];
    if(isset($_POST["reset"])){
        ...
        $sql = mysqli_query($conn, "SELECT * FROM cust_info WHERE email='$email'")->fetch_assoc() or die(mysqli_error($conn));
        ...
        if($email){
            ...
            mysqli_query($conn, "UPDATE customers SET password='$new_pass' WHERE username='$username'");
